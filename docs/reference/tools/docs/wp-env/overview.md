...
**Canonical source:** https://github.com/WordPress/gutenberg/blob/trunk/docs/getting-started/devenv/get-started-with-wp-env.md  
**Role in this project:** Docker-backed local WordPress development environment  
**Research date:** 2026-08-01

## What it is

Node CLI from @wordpress/env that creates WordPress, database, CLI, and optional test services with Docker; configured by .wp-env.json and overrides.
...
- Planned phases: 00 and every test/release phase.
