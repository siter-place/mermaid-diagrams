# Bruno Agent Skills — Architecture and Technology

## Main architectural characteristics

- Collection generator establishes folders, requests, environments, variables, and naming.
- Test writer supplies assertion/chaining/error-case patterns.
- CI setup aligns CLI invocation, reports, sandbox mode, and secret injection.
