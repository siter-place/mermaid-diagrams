# Mermaid React Flow Editor — Architecture and Technology

## Main architectural characteristics

- Parser/converter builds an intermediate graph model.
- React Flow provides viewport, node, edge, selection and layout interaction.
- Serializer reconstructs Mermaid source.
- Unsupported syntax and identity/layout preservation are core round-trip risks.
