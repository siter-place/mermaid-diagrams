# WordPress DataViews — Architecture and Technology

## Main architectural characteristics

- Declarative field definitions and view configuration.
- Data fetching stays outside the view component.
- Actions operate on selected records.
- Layouts can include table/grid depending package stability.
