# getdokan/plugin-ui — Architecture and Technology

## Main architectural characteristics

- Provider composition establishes notices, data/config, routing and styling.
- Settings are server-authoritative, sectioned, normalized, and saved through a client abstraction.
- Components and feature modules are separated from WordPress bootstrapping.
- CSS scope/isolation prevents wp-admin collisions.
