# jsDelivr Mermaid Distribution — Architecture and Technology

## Main architectural characteristics

- Resolves npm packages and files through globally distributed CDN endpoints.
- Unversioned URLs may move as package releases change.
