# WordPress Playground and Blueprints — Architecture and Technology

## Main architectural characteristics

- Blueprint describes setup steps and assets.
- Can create portable plugin previews independent of local Docker.
- Complements, not replaces, wp-env for main development.
