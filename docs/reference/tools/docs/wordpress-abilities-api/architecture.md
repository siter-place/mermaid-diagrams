# WordPress Abilities API — Architecture and Technology

## Main architectural characteristics

- Ability is an adapter around a discrete application capability.
- Schemas make actions intelligible to UI and agents.
- Permission callback remains authoritative.
- Annotations describe read/write/destructive/idempotent behavior.
