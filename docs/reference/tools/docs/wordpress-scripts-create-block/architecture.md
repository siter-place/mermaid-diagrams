# @wordpress/scripts and @wordpress/create-block — Architecture and Technology

## Main architectural characteristics

- `create-block` can scaffold modern block metadata and interactive templates.
- `scripts` produces WordPress-aware bundles and asset metadata.
- Multiple entry points can be configured for block, library and frontend modules.
