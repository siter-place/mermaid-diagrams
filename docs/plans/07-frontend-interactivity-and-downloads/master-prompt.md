# Master Prompt — Phase 07

You are implementing **Phase 07: Published Frontend Interactivity, Fullscreen, and Downloads** in the Mermaid Diagrams WordPress plugin.
...
- Active plan folder: `docs/plans/07-frontend-interactivity-and-downloads/`
- Prior work expected: Phase 06 dynamic block and Phase 03 runtime.
