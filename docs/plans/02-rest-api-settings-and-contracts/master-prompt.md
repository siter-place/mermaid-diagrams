# Master Prompt — Phase 02

You are implementing **Phase 02: REST API, Settings, Error Model, and Shared Contracts** in the Mermaid Diagrams WordPress plugin.
...
- Active plan folder: `docs/plans/02-rest-api-settings-and-contracts/`
- Prior work expected: Phase 01 domain/repositories/capabilities complete.
