# Master Prompt — Phase 08

You are implementing **Phase 08: Adapted Mermaid Live Editor, Save, Revisions, and Conflicts** in the Mermaid Diagrams WordPress plugin.
...
- Active plan folder: `docs/plans/08-svelte-mermaid-live-editor-integration/`
- Prior work expected: Phases 02–03 persistence/validation and Phase 00 Live Editor spike.
