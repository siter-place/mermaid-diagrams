...
You are implementing **Phase 10: WordPress AI Client Diagram Assistance** in the Mermaid Diagrams WordPress plugin.
...
- Active plan folder: `docs/plans/10-wordpress-ai-diagram-assistance/`
- Prior work expected: Phase 08 editor, Phase 03 validation, WordPress 7 AI connector configured.
