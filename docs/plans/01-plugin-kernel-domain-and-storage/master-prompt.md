# Master Prompt — Phase 01

You are implementing **Phase 01: Plugin Kernel, Domain Model, Storage, and Capabilities** in the Mermaid Diagrams WordPress plugin.
...
- Active plan folder: `docs/plans/01-plugin-kernel-domain-and-storage/`
- Prior work expected: Phase 00 accepted; toolchain and dependency decisions pinned.
