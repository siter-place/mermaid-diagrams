# Master Prompt — Phase 03

You are implementing **Phase 03: Mermaid Validation, Rendering, SVG, and Validation Worker** in the Mermaid Diagrams WordPress plugin.
...
- Active plan folder: `docs/plans/03-mermaid-validation-rendering-and-export/`
- Prior work expected: Phase 02 contracts/routes exist.
