# Master Prompt — Phase 09

You are implementing **Phase 09: SVG Thumbnails, Featured Images, Usage Index, and WP-Cron** in the Mermaid Diagrams WordPress plugin.
...
- Active plan folder: `docs/plans/09-svg-thumbnails-featured-images-and-usage-index/`
- Prior work expected: Phases 05–08 can create/reference/render diagrams.
