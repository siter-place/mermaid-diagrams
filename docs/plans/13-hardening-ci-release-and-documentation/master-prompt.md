# Master Prompt — Phase 13

You are implementing **Phase 13: Security, Accessibility, Performance, CI, and Release** in the Mermaid Diagrams WordPress plugin.
...
- Active plan folder: `docs/plans/13-hardening-ci-release-and-documentation/`
- Prior work expected: All release-target phases complete; Phase 12 may be included or feature-flagged/deferred.
