# Master Prompt — Phase 06

You are implementing **Phase 06: Gutenberg Block, Inline Diagrams, and Library References** in the Mermaid Diagrams WordPress plugin.
...
- Active plan folder: `docs/plans/06-gutenberg-block-and-library-references/`
- Prior work expected: Phases 02–05 provide REST, rendering, and library data.
