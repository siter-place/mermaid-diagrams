...
You are implementing **Phase 12: Flowchart Visual Editor Adapter** in the Mermaid Diagrams WordPress plugin.
...
- Active plan folder: `docs/plans/12-flowchart-visual-editor-adapter/`
- Prior work expected: Phases 03 and 08 stable; representative corpus and visual baselines exist.
