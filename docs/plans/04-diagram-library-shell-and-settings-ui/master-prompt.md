# Master Prompt — Phase 04

You are implementing **Phase 04: React Diagram Library Shell and Settings UI** in the Mermaid Diagrams WordPress plugin.
...
- Active plan folder: `docs/plans/04-diagram-library-shell-and-settings-ui/`
- Prior work expected: Phases 01–03 provide data, REST, settings, and valid fixtures.
