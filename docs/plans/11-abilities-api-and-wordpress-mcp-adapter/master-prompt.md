...
You are implementing **Phase 11: Abilities API and WordPress MCP Adapter** in the Mermaid Diagrams WordPress plugin.
...
- Active plan folder: `docs/plans/11-abilities-api-and-wordpress-mcp-adapter/`
- Prior work expected: Application services from Phases 02–03, 09–10; MCP Adapter choice from Phase 00.
