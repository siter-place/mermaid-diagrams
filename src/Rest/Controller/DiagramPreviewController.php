<?php
/**
 * REST Diagram Preview Controller (/mdm/v1/diagrams/{id}/preview).
 *
...
/**
 * Controller for on-demand diagram preview render payload.
 */
class DiagramPreviewController extends WP_REST_Controller {
	...
	/**
	 * Permission check for preview endpoint.
	 *
	 * @param WP_REST_Request $request REST request.
	 * @return bool
	 */
	public function get_preview_permissions_check( $request ): bool {
	...
	public function get_preview( $request ) {
		try {
			...
			$preview = $this->diagram_service->get_diagram_preview( $query );
